...
/*
  ...
  - Return the response.
 */
async function handleMove(req, res, token) {
    try {
        ...
        await fetch(`${config_1.API_URL}/v1/files/${targetFile.id}/move`, {
            method: 'POST',
            headers: {
                'Authorization': `Bearer ${token.access_token}`,
                'Content-Type': 'application/json',
...
exports.default = handleMove;
//# sourceMappingURL=handle-move.js.map