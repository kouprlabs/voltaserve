...
/*
  ...
  - Return the response.
 */
async function handleOptions(_, res) {
    res.statusCode = 200;
    res.setHeader('Allow', 'OPTIONS, GET, HEAD, PUT, DELETE, MKCOL, COPY, MOVE, PROPFIND, PROPPATCH');
    res.end();
}
exports.default = handleOptions;
//# sourceMappingURL=handle-options.js.map