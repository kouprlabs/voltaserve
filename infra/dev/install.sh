...
install_dnf_package "python3-devel" # Required by spacy-fastlang in language microservice
install_pip_package "pipenv" "2023.6.12"

install_dnf_package "poppler-utils" # Used by conversion microservice (pdftotext)
...
install_dnf_package "pngquant"            # From EPEL
install_dnf_package "unpaper"             # From EPEL
install_dnf_package "perl-Image-ExifTool" # From EPEL

# Build tools for building jbig2enc
...
# Dependencies for building jbig2enc
...
install_pip_package "ocrmypdf" "14.2.1" # Used by conversion microservice

install_nodejs_18
install_corepack # Needed to get PNPM

install_dnf_package "golang"
install_air      # Used by all Go microservices
install_golangci # Used by all Go microservices
install_swag     # Used by api microservice
