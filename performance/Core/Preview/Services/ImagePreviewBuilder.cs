namespace Defyle.Core.Preview.Services
{
  ...
  public class ImagePreviewBuilder
	{
		private readonly PreviewMessage.ImagePreviewPayload _options;
		
    private readonly ExternalAppSettings _binary;

		public ImagePreviewBuilder(
      PreviewMessage.ImagePreviewPayload options,
		...
		public void Build()
    {
      ...
      try
      {
        ...
        {
          binary = _binary.App;
          args = $"-mt {_options.File} -o {Path.Combine(_options.OutputDirectory, filename)}";
        }
