namespace Defyle.Core.Preview.Services
{
  ...
  public enum ActionOnExistingDirectory
	...
	public class TileMapBuilder
	{
		...
		private readonly PreviewMessage.TileMapPayload _options;
		...
		public TileMapBuilder(PreviewMessage.TileMapPayload options)
		{
			_options = options;
		}
      ...
      File.WriteAllText(GetZoomLevelMetadataFilePath(zoomLevelIndex),
		...
		private float GetScaleDownPercentage(int zoomLevel)
		{
			float value = 100.0f;
		...
		/// <returns>Zoom level indexes</returns>
